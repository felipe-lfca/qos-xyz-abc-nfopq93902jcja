# 3.06 Noções de licitações e contratos administrativos
...
| Campo | Valor |
| :---- | :---- |
| Exigido em | 2013, 2023, 2024 |
| Nº de editais | 3 de 4 |
| Questões nas provas | 3 |
| Incidência | Média incidência |

Exigido nos editais de 2013, 2023 e 2024 — 3 de 4 editais. Gerou 3 questões no conjunto das provas de 2013, 2017, 2023 e 2024.
...
- #Q2024-31 (ETP — art. 18; gabarito D)
- #Q2024-32 (fases do processo licitatório — art. 17; gabarito A)
...
## Transcrição — Lei nº 14.133/2021 (Licitações e Contratos) — texto integral

> [!IMPORTANT]
> Transcrição *ipsis litteris* da **Lei nº 14.133, de 1º de abril de 2021** (Lei de Licitações
> e Contratos Administrativos), a partir do texto consolidado no Portal da Legislação
> (Planalto). Migrada em 05/09/2026. O texto corrido não foi alterado; apenas a marcação
> HTML foi convertida em Markdown (parágrafos e cabeçalhos de Título/Capítulo/Seção).
> Remissões a decretos, mensagem de veto e notas de vigência do cabeçalho da página foram
> omitidas; o articulado (arts. 1º–194) está integral.
>
> Âncora do documento completo: **este arquivo (3.06)**. Trechos de planejamento/aquisição
> também em [3.03](3.03%20Programa%C3%A7%C3%A3o%20e%20aquisi%C3%A7%C3%A3o%20de%20medicamentos%20e%20produtos%20para%20sa%C3%BAde.md).
...
IV - comércio eletrônico: caso em que a Administração visa a contratar bens e serviços comuns padronizados ofertados no Sistema de Compras Expressas (Sicx). (Incluído pela Lei nº 15.266, de 2025) Regulamento Vigência
