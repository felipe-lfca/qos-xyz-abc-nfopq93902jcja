...
#### 7. MATÉRIAS-PRIMAS E MATERIAIS DE EMBALAGEM (Roteiro de Inspeção)
...
##### 7.4. Armazenamento (Roteiro de Inspeção)
...
- **Treino ativo:** [Testes V/F deste tópico](testes/2.07%20Controle%20de%20qualidade%20de%20mat%C3%A9rias-primas%3B%20emiss%C3%A3o%20e%20an%C3%A1lise%20de%20laudos.md) — 80 itens cobrindo aquisição, recebimento, controle de qualidade (incluindo matérias-primas vegetais e terceirização de análises), armazenamento e água (potável e purificada), além do Roteiro de Inspeção correspondente.
...
- [ ] 1ª leitura
- [ ] Resumo escrito
- [x] Testes V/F gerados (80 itens — cobre integralmente o item 7 do Anexo I e o Roteiro de Inspeção correspondente; falta só "Resumo do tópico" e "Pontos-chave", ainda vazios)
- [ ] Questões resolvidas
- [ ] Revisão final
