...
> [!NOTE]
> **Por que "mL representa gramas"?** — nota explicativa, gerada por IA; não faz parte do texto original de Ansel.
>
> A % p/v (peso/volume) é, por definição rigorosa, gramas de soluto em 100 **g** de preparação — um percentual "peso a peso" de verdade. Só que pesar 100 g de uma solução na bancada dá mais trabalho do que medir 100 mL numa proveta, daí a convenção prática adotada neste capítulo.
>
> A ponte entre as duas grandezas é a densidade relativa (*specific gravity*, "sp gr"), já apresentada acima: $\mathrm{g} = \mathrm{mL} \times \mathrm{sp\ gr}$. Quando se assume sp gr = 1 — a densidade da própria água, e uma aproximação razoável para a maioria das soluções aquosas diluídas — a fórmula vira $\mathrm{g} = \mathrm{mL} \times 1 = \mathrm{mL}$: o número que mede o volume em mL passa a valer, numericamente, o mesmo que o peso em gramas.
>
> É por isso que "100 mL representam 100 g": não é coincidência de unidades, é a densidade da água (1 g/mL) emprestada como aproximação da densidade da solução. O preço dessa simplificação é um pequeno erro sempre que a solução real tiver sp gr bem diferente de 1 (xaropes concentrados, soluções com solutos muito densos) — nesses casos a % p/v "de bancada" diverge um pouco da % p/p "verdadeira". Mesmo assim, é essa convenção — mL tratado como g — que o capítulo e a prova usam em toda a seção seguinte.
...
> [!NOTE]
> **Destrinchando o exemplo acima** — nota explicativa, gerada por IA; não faz parte do texto original de Ansel. O enunciado é mesmo confuso da forma como o livro resolve — vamos por partes.
>
> **1. Por que ele fala em "800 g de água = 800 mL"?** Os 800 g **não são de água**. São de um líquido qualquer, mais leve que a água. O livro usa a água só como ponto de partida: a água tem densidade 1, então 1 g ocupa 1 mL. Se fossem 800 g de água, seriam 800 mL — mas não é água.
>
> **2. Por que dividir pela gravidade específica?** Gravidade específica 0,800 significa que o líquido pesa 0,8 g por mL (80% da densidade da água). Como a questão pede % **v/v**, é preciso o **volume** do líquido, não a massa. A conversão é volume = massa ÷ densidade = 800 g ÷ 0,800 g/mL = **1000 mL**. Faz sentido: um líquido mais leve ocupa **mais** espaço para a mesma massa — por isso 800 g dele ocupam mais que 800 mL, no caso 1000 mL.
>
> **3. De onde vem o "100" na proporção?** Não são 100 g, e sim **100 mL de solução**. Porcentagem v/v significa "quantos mL de soluto existem em cada 100 mL de solução". A regra de três é: 1000 mL de soluto está para 4000 mL de solução, assim como x mL de soluto está para 100 mL de solução → x = 1000 × 100 ÷ 4000 = **25**, ou seja, **25% v/v**.
>
> **Resumo em uma linha:** converte a massa em volume (800 ÷ 0,8 = 1000 mL), divide pelo volume total (1000 ÷ 4000 = 0,25) e multiplica por 100 — dá **25%**.
>
> Pegadinha para guardar: sempre que a questão der o soluto em **gramas** e pedir **% v/v**, a gravidade específica está ali para converter g em mL.
