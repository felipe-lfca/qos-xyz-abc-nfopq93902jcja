...
- **ANSEL, H. C.** *Pharmaceutical Calculations*. 13. ed. Philadelphia: Lippincott Williams & Wilkins, 2010. Edição brasileira: *Cálculos Farmacêuticos* (Artmed/Grupo A). O [capítulo 6](#transcrição--ansel-13ª-ed-capítulo-6) está transcrito neste arquivo. Caps. 9, 13, 15 e 17 — ainda a transcrever; o mapa está em [Onde isso está no Ansel](#onde-isso-está-no-ansel). A 15ª (2017) e a 16ª (*Stoklosa and Ansel's*, 2022) mantêm os mesmos blocos (infusões no cap. 13; diluição no cap. 15).
