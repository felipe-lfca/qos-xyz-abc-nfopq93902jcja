...
Levantamento fechado em **setembro de 2026**. Oito notas ao longo da transcrição. Onde o trecho de 2010 ficou incorreto, a nota registra o que o original dizia, o que vale hoje e a fonte.
...
Imagens, esquemas e anexos deste eixo ficam na pasta `recursos/`, ao lado deste arquivo. As figuras do capítulo 9 estão em `recursos/ansel13-cap9/`; as do capítulo 17, em `recursos/ansel13-cap17/`.
...
- [ ] 1ª leitura
- [x] Resumo escrito
- [x] Capítulos 6, 9, 13 e 17 do Ansel (13ª ed.) transcritos; 8 notas no cap. 9 e 9 notas no cap. 17 (05/09/2026)
- [ ] Questões resolvidas
- [ ] Revisão final
