...
Imagens, esquemas e anexos deste eixo ficam na pasta `recursos/`, ao lado deste arquivo. Figuras do Ansel: `recursos/ansel13-cap9/` (cap. 9) e `recursos/ansel13-cap15/` (cap. 15). Para referenciar:
...
- [ ] 1ª leitura
- [x] Resumo escrito
- [x] Capítulos 6, 9, 13 e 15 do Ansel (13ª ed.) transcritos; 8 notas no cap. 9 e 5 no cap. 15 (05/09/2026)
- [ ] Questões resolvidas
- [ ] Revisão final
