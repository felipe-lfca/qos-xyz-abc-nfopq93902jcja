...
- **ANSEL, H. C.** *Pharmaceutical Calculations*. 13. ed. Philadelphia: Lippincott Williams & Wilkins, 2010. Edição brasileira: *Cálculos Farmacêuticos* (Artmed/Grupo A). Os capítulos [6](#transcrição--ansel-13ª-ed-capítulo-6), [9](#transcrição--ansel-13ª-ed-capítulo-9-unidades-de-atividade-e-outras-medidas-de-potência) e [13](#transcrição--ansel-13ª-ed-capítulo-13) estão transcritos neste arquivo. Caps. 15 e 17 — ainda a transcrever; o mapa está em [Onde isso está no Ansel](#onde-isso-está-no-ansel). A 15ª (2017) e a 16ª (*Stoklosa and Ansel's*, 2022) mantêm os mesmos blocos (infusões no cap. 13; diluição no cap. 15); a 16ª ainda descreve insulina só como U-100 ou U-500.
...
- [ ] 1ª leitura
- [x] Resumo escrito
- [x] Capítulos 6, 9 e 13 do Ansel (13ª ed.) transcritos; 8 notas de atualização no cap. 9 (05/09/2026)
- [ ] Questões resolvidas
- [ ] Revisão final
